...
import com.gabriel.draw.command.SetFillColorCommand;
...
public class DeawingCommandAppService implements AppService {
    ...
    public void setColor(Color color) {
        ...
        Command command = new SetColorCommand(appService,appService.getColor(), color);
    }
    ...
    public void setFill(Color color) {
        ...
        Command command = new SetFillColorCommand(appService, appService.getFill(), color);
        CommandService.ExecuteCommand(command);
    }
